...
# READ THE DATA
sst = np.loadtxt('deltaTvert')  # input SST time series
...
time=np.linspace(41,69,len(sst))
#time=np.linspace(0,36,len(sst))
...
pl.y = period
pl.xlabel = 'y-axis (km)'
pl.ylabel = 'horizontal wavelength (km)'
pl.title = 'Wavelet Power Spectrum'
pl.logy = True
pl.invert = True
pl.colorbar = "hot"
pl.ymax = ymax
